...
buildNpmPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    rev = "4ced997d6398048841d7c7a5c99b9b7a8209ef88";
    hash = "sha256-ms8oBJkj2BTEYLXeF71MrEPfcJnGgITN+iMw0eu+USU=";
  };

  npmDeps = fetchNpmDeps {
    inherit (finalAttrs) src;
    hash = "sha256-53ZlEsxyW7pz2DJpWp57Epc35i9an9rfW4AE53qMwnY=";
  };
